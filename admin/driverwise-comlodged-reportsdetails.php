...
$sql="SELECT  tbldriver.DriverID,tbldriver.Name,tbllodgedcomplain.AssignTo,
...
join tbldriver on tbldriver.DriverID=tbllodgedcomplain.AssignTo 
where date(AssignDate) between '$fdate' and '$tdate' group by tbldriver.Name,DriverID";
